  ...
  return (
    <div>
      <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
        <h1 className="font-[600] text-[15px] uppercase">Order Details</h1>
                    ...
                    <tbody>
                      ...
                      {section === "b2B" ? (
                        <tr className="odd:bg-[#f3f6f9]">
                          ...
                          <td className="p-2">
                            {order?.agentReferenceNumber || "N/A"}
                          </td>
                        </tr>
                      ) : (
                        ""
                ...
                <div>
                  <div className="px-2">
                    {order?.attractionOrder && (
                      <>
                        ...
                        <div className="odd:bg-[#f3f6f9]">
                          <h2 className="p-2 w-[180px]">Activities</h2>
                        </div>
                        <table className="w-full text-[15px]">
                          <tbody>
                              ...
                              <td className="font-medium py-1 w-full">
                                <div className="flex gap-[15px] items-center w-full">
                                  ...
                                  <span className="text-right">
                                    -{" "}
                                    {order?.attractionOrder?.discountOffer || 0}
                                  </span>
                                </div>
                              </td>
                            </tr>
                    ...
                    {order?.transferOrder && (
                      <>
                        <div className="odd:bg-[#f3f6f9]">
                          <h2 className="p-2 w-[180px]">Transfer</h2>
                        </div>
                        <table className="w-full text-[15px]">
                          <tbody>
                          ...
                          (item, orderItemIndex) => {
                            return (
                              <tr key={orderItemIndex}>
                                ...
                                <td className="p-3">
                                  {item?.noOfAdults} ADT, {item?.noOfChildrens}{" "}
                                  CHD{" "}
                                </td>
