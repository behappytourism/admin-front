...
export default function OrdersCancellationListingPage() {
    ...
    const { b2bCancellationOrderCount } = useSelector((state) => state.general);
        ...
        try {
            ...
            if (section === "b2b") {
                response = await axios.get(
                    `/orders/b2b/cancel/all?skip=${filters.skip}&limit=${filters.limit}&referenceNo=${filters.referenceNo}&agentCode=${filters.agentCode}&orderDateFrom=${filters.orderDateFrom}&orderDateTo=${filters.orderDateTo}&orderStatus=${filters.orderStatus}&traveller=${filters.traveller}`,
                    {
                ...
                response = await axios.get(
                    `/orders/b2c/all?skip=${filters.skip}&limit=${filters.limit}&referenceNo=${filters.referenceNo}&orderDateFrom=${filters.orderDateFrom}&orderDateTo=${filters.orderDateTo}&orderStatus=${filters.orderStatus}&traveller=${filters.traveller}`,
                    {
                        headers: { authorization: `Bearer ${jwtToken}` },
                    }
                );
                ...
                <div className="bg-white rounded shadow-sm">
                    <div className="flex items-center justify-between border-b border-dashed p-4">
                        <h1 className="font-medium">
                            All Cancellation Request Orders
                        </h1>
                        <button
