...
export default function SingleResellerOrdersPage() {
    ...
    const fetchOrders = async ({ section, ...filters }) => {
        try {
            ...
            response = await axios.get(
                `/orders/b2b/all?userId=${id}&skip=${filters.skip}&limit=${filters.limit}&referenceNo=${filters.referenceNo}&orderDateFrom=${filters.orderDateFrom}&orderDateTo=${filters.orderDateTo}&orderStatus=${filters.orderStatus}&traveller=${filters.traveller}`,
                {
