        ...
        try {
            ...
            await axios.patch(
                `/promo-code/update/${id}`,
                {
                    ...
                    type: "flat",
                    value: data.value || "",
                    isSpecific: data.isSpecific || false,
                    users: data.users || "",
                    isValid: data.isValid || false,
                    fromValidity: data.fromValidity || "",
                    toValidity: data.toValidity || "",
                    minPurchaseValue: data.minPurchaseValue || "",
                    maxPromoDiscount: data.maxPromoDiscount || "",
                    useageCount: data.useageCount || "",
                    useagePerPersonCount: data.useagePerPersonCount || "",
                },
                {
                    headers: { authorization: `Bearer ${jwtToken}` },
                }
    ...
    return (
        <div>
            <div className="bg-white flex items-center justify-between gap-[10px] px-6 shadow-sm border-t py-2">
                <h1 className="font-[600] text-[15px]">EDIT PROMO CODE</h1>
